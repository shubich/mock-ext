...
(function (global) {
  ...
  const MESSAGES = {
    en: {
      ...
      filterRules: "Search URL, status, body…",
      clear: "Clear",
      refresh: "Refresh",
      exportRules: "Export",
      importRules: "Import",
      exportRulesTitle: "Export rules to JSON",
      importRulesTitle: "Import rules from JSON",
      addRule: "Add rule",
      thOrder: "Order",
      showRuleOrder: "Rule order",
      showRuleOrderTitle: "Show ↑↓ column to change rule priority",
      ...
      replayInSend: "Open in Send",
      replayInSendTitle: "Copy this captured request to the Send tab (via page, mocks apply)",
      close: "Close",
      save: "Save",
      create: "Create",
      delete: "Delete",
      ...
      statusLoadedCapture: "Captured request opened in Send",
    ...
    ru: {
      ...
      filterRules: "Поиск: URL, статус, body…",
      clear: "Очистить",
      refresh: "Обновить",
      exportRules: "Экспорт",
      importRules: "Импорт",
      exportRulesTitle: "Экспорт правил в JSON",
      importRulesTitle: "Импорт правил из JSON",
      addRule: "Добавить",
      thOrder: "Порядок",
      showRuleOrder: "Порядок",
      showRuleOrderTitle: "Показать колонку ↑↓ для смены приоритета правил",
      ...
      replayInSend: "Открыть в Отправке",
      replayInSendTitle: "Перенести захваченный запрос на вкладку Отправка (через страницу, моки работают)",
      close: "Закрыть",
      save: "Сохранить",
      create: "Создать",
      delete: "Удалить",
      ...
      statusLoadedCapture: "Захваченный запрос открыт в Отправке",
